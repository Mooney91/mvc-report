...
<html>
    <head>
        ...
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("img/moon.png"), "html", null, true);
        echo "\">
    ...
    <body>
        ...
        // line 22
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("img/background.jpg"), "html", null, true);
        echo ")\">
      ...
      <footer class = \"footer\">Zachary Mooney &#169; 2023 - Let's explore mvc together.</footer>
    </body>
</html>
";
...
", "base.html.twig", "/home/mooney/dbwebb-kurser/mvc/me/report/templates/base.html.twig");
    }
}
