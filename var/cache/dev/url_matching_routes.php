...
return [
    ...
    [ // $staticRoutes
        ...
        '/proj/economy' => [[['_route' => 'proj-economy', '_controller' => 'App\\Controller\\ProjectController::economy'], null, null, null, false, false, null]],
        ...
        '/proj/api/education/male' => [[['_route' => 'proj_api_education_male', '_controller' => 'App\\Controller\\ProjectController::projApiEducationMale'], null, null, null, false, false, null]],
        '/proj/api/education/female' => [[['_route' => 'proj_api_education_female', '_controller' => 'App\\Controller\\ProjectController::projApiEducationFemale'], null, null, null, false, false, null]],
        '/proj/api/education/year' => [[['_route' => 'proj_api_education_year', '_controller' => 'App\\Controller\\ProjectController::projApiEducationYear'], null, ['POST' => 0], null, false, false, null]],
        '/proj/api/loweconomic' => [[['_route' => 'proj_api_loweconomic', '_controller' => 'App\\Controller\\ProjectController::projApiLowEconomic'], null, null, null, false, false, null]],
        '/proj/api/loweconomic/birthplace' => [[['_route' => 'proj_api_loweconomic_birthplace', '_controller' => 'App\\Controller\\ProjectController::projApiLowEconomicBirthplace'], null, ['POST' => 0], null, false, false, null]],
        '/proj/api/ageeconomic' => [[['_route' => 'proj_api_ageeconomic', '_controller' => 'App\\Controller\\ProjectController::projApiAgeEconomic'], null, null, null, false, false, null]],
