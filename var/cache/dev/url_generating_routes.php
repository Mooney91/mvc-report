...
return [
    ...
    'proj-economy' => [[], ['_controller' => 'App\\Controller\\ProjectController::economy'], [], [['text', '/proj/economy']], [], [], []],
    ...
    'proj_api_education_male' => [[], ['_controller' => 'App\\Controller\\ProjectController::projApiEducationMale'], [], [['text', '/proj/api/education/male']], [], [], []],
    'proj_api_education_female' => [[], ['_controller' => 'App\\Controller\\ProjectController::projApiEducationFemale'], [], [['text', '/proj/api/education/female']], [], [], []],
    'proj_api_education_year' => [[], ['_controller' => 'App\\Controller\\ProjectController::projApiEducationYear'], [], [['text', '/proj/api/education/year']], [], [], []],
    'proj_api_loweconomic' => [[], ['_controller' => 'App\\Controller\\ProjectController::projApiLowEconomic'], [], [['text', '/proj/api/loweconomic']], [], [], []],
    'proj_api_loweconomic_birthplace' => [[], ['_controller' => 'App\\Controller\\ProjectController::projApiLowEconomicBirthplace'], [], [['text', '/proj/api/loweconomic/birthplace']], [], [], []],
    'proj_api_ageeconomic' => [[], ['_controller' => 'App\\Controller\\ProjectController::projApiAgeEconomic'], [], [['text', '/proj/api/ageeconomic']], [], [], []],
